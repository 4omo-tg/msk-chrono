        ...
        <div class="space-y-3">
            {#if !showTelegramInput}
                <button
                    ...
                    class="w-full flex items-center justify-center gap-2 py-3 px-4 border border-[#0088cc] text-sm font-medium rounded-md text-white bg-[#0088cc] hover:bg-[#0077b5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0088cc] transition-colors"
                >
            ...
            {:else}
                ...
                <div class="flex gap-2">
                    ...
                    <button
                        type="button"
                        on:click={handleTelegramRegister}
