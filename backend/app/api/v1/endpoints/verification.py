...
GESTURES = [
    ...
    {"id": "fist", "name": "Кулак ✊", "description": "Покажите сжатый кулак рядом с достопримечательностью"},
    {"id": "rock", "name": "Коза 🤘", "description": "Покажите рок-жест (козу) рядом с достопримечательностью"},
    {"id": "point_up", "name": "Указательный палец вверх ☝️", "description": "Покажите указательный палец вверх рядом с достопримечательностью"},
    {"id": "shaka", "name": "Шака 🤙", "description": "Покажите жест шака (большой палец и мизинец) рядом с достопримечательностью"},
    {"id": "crossed_fingers", "name": "Скрещенные пальцы 🤞", "description": "Покажите скрещенные пальцы рядом с достопримечательностью"},
    {"id": "love_you", "name": "Люблю тебя 🤟", "description": "Покажите жест 'I love you' (большой, указательный и мизинец)"},
    {"id": "three", "name": "Три пальца ☘️", "description": "Покажите три пальца рядом с достопримечательностью"},
    {"id": "four", "name": "Четыре пальца ✂️", "description": "Покажите четыре пальца (без большого) рядом с достопримечательностью"},
]
    ...
    if file is not None:
        ...
        async with httpx.AsyncClient(timeout=120.0) as client:
            try:
                ...
                # Build prompt text with gesture descriptions
                gesture_descriptions = {
                    "thumbs_up": "большой палец вверх (как лайк)",
                    "peace": "знак мира/победы - два пальца (указательный и средний) подняты вверх в форме буквы V",
                    "ok": "знак OK - большой и указательный пальцы соединены в кольцо, остальные выпрямлены",
                    "wave": "раскрытая ладонь с растопыренными пальцами (как приветствие)",
                    "fist": "сжатый кулак",
                    "rock": "рок-жест/коза - указательный палец и мизинец подняты, остальные сжаты",
                    "point_up": "указательный палец направлен вверх, остальные сжаты",
                    "shaka": "жест шака/серфера - большой палец и мизинец оттопырены, остальные сжаты",
                    "crossed_fingers": "скрещенные пальцы - средний палец поверх указательного",
                    "love_you": "жест 'I love you' - большой палец, указательный и мизинец подняты",
                    "three": "три пальца подняты вверх (указательный, средний, безымянный)",
                    "four": "четыре пальца подняты (все кроме большого)",
                }
                
                gesture_detail = gesture_descriptions.get(gesture_id, gesture_info['description'])
...
- Как выглядит жест: {gesture_detail}

ВАЖНО: Жест должен быть хорошо виден на фото. Рука человека должна показывать именно этот жест.

Проверь:
1. Видна ли достопримечательность "{poi.title}" на фото?
2. Виден ли требуемый жест {gesture_info['name']} на фото? (жест: {gesture_detail})
